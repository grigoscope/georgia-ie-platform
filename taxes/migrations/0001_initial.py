        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'calculation_status',
                    models.CharField(
                        default='pending', max_length=30, verbose_name='Статус расчёта'
                    ),
                ),
                (
                    'declaration_status',
                    models.CharField(
                        default='not_submitted', max_length=30, verbose_name='Статус декларации'
                    ),
                ),
                (
                    'submitted_at',
                    models.DateTimeField(
                        blank=True, null=True, verbose_name='Дата подачи декларации'
                    ),
                ),
                (
                    'submission_comment',
                    models.TextField(blank=True, verbose_name='Комментарий к подаче'),
                ),
                (
                ...
                (
                    'payment_status',
                    models.CharField(
                        default='not_paid', max_length=30, verbose_name='Статус оплаты'
                    ),
                ),
                (
                    'paid_at',
                ...
                (
                    'payment_comment',
                    models.TextField(blank=True, verbose_name='Комментарий к оплате'),
                ),
                (
                ...
                (
                    ...
                    models.BooleanField(default=False, verbose_name='Изменено после подачи'),
                ),
                (
                    'calculated_at',
                    models.DateTimeField(blank=True, null=True, verbose_name='Дата расчёта'),
                ),
                (
                    'created_at',
            ...
            options={
                'indexes': [
                    models.Index(fields=['user', 'deadline'], name='taxes_taxpe_user_id_165475_idx')
                ],
                'constraints': [
                    models.UniqueConstraint(
                        fields=('user', 'year', 'month'), name='unique_tax_period_per_user'
                    ),
